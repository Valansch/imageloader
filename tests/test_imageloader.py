...
test_input_file_content = " https://goog le.com\nhttps://google.com\n https://example.org"
...
def test_download_url_404():
    assert not download("https://google.com/path_does_not_exist", test_file_output_file_path)
...
def test_validate_arguments(mockExit):
    ...
    rv = mockExit.call_args_list[0].args[0] 
